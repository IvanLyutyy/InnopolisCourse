...
public class PersonRegistry {
    ...
    public void showPersons() {
        if (persons.length == 1 && persons[0] == null) {
            System.out.println(EMPTY_PERSONS);
        } else {
    ...
    public void addPerson(Person person) {
        ...
        System.out.printf("Персона добавлена в список: {}", person);
    }
    ...
    public void sortPersonWithSuperComparator() {
        if (persons.length == 1 && persons[0] == null) {
            ...
            System.out.println("Список персон отсортирован по возрасту, по имени.");
    ...
    public void sortPersonByNameByAge() {
        if (persons.length == 1 && persons[0] == null) {
            ...
            System.out.println("Список персон отсортирован по имени, по возрасту.");
    ...
    public void shufflePersons() {
        if (persons.length == 1 && persons[0] == null) {
            ...
            System.out.println("Список персон перемешан.");
            showPersons();
        }
    }
}
